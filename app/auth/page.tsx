      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-sm border border-border bg-card p-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button className="animate-pulse-glow w-full rounded-sm border border-primary bg-primary px-4 py-2.5 text-sm font-bold uppercase tracking-widest text-primary-foreground transition-all hover:bg-primary/90">
              Initialize Session
            </button>
          </div>
